...
class List_ACTION_DRM_VIEW_REQUEST_FAILED extends React.Component {
    ...
    constructor(props) {
        ...
        // const _Requests = this.props.data.reduce((i, { user, Hits }) => {
        //     (i[user] = i[user] || []).push(Hits);
        //     return i;
        //   }, {});
            ...
            <div className="p-grid p-fluid" style={{padding: '2em 1em 1em 1em'}}>
                <div className="p-col-12 p-md-3" style={{textAlign:'center'}}>
                    ...
                    <div className="p-grid">
                        ...
                        <div className="p-md-10" style={{fontWeight:'bold'}}>{data.filename}</div>

                        {/* <div className="p-md-2">Email: </div>
                        <div className="p-md-10" style={{fontWeight:'bold'}}></div> */}
...
export default List_ACTION_DRM_VIEW_REQUEST_FAILED;